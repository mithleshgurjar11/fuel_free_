class Env {
  ...
  static String global_user_email = "";

  static var CurrentUser;
  static String userName = "default";
  static String userEmail = "default";
  static String userNumber = "default";
  static String userAddress = "default";
  static String userImage = "default";
  static int userId = -999;
}
