...
class Type {
 ...
 // late final double TouchScreenSize;
  ...
  Type.fromJson(Map<String, dynamic> json){
   ...
   // ChargingTime =double.parse(json['ChargingTime']??int.parse(json["ChargingTime"]));
   ...
   // TouchScreenSize =double.parse(json['TouchScreenSize']??int.parse(json["TouchScreenSize"]));
