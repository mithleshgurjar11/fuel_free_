...
import 'package:fuel_free/Screen/Utilities/charging_product_details.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:readmore/readmore.dart';
import 'package:share_plus/share_plus.dart';

class ChargingpointDetails extends StatefulWidget {
  const ChargingpointDetails({Key? key}) : super(key: key);

  @override
  State<ChargingpointDetails> createState() => _ChargingpointDetailsState();
}

class _ChargingpointDetailsState extends State<ChargingpointDetails> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        elevation: 1,
        title: Center(
            child: Text("Charging Point Details",
              style: TextStyle(
                      ...
                      InkWell(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => const ChargingProductDetails(),
                            ),
                          );
                        },
                      ),
